...
$ous = @(
    ...
    @{Name="Securite"; Computers=@("SecurityPC-Mirage"); Users=@("SecurityChief-Mirage", "SecurityGuard1-Mirage", "SecurityGuard2-Mirage")},
        ...
        if (-not (Get-ADUser -Filter "SamAccountName -eq '$samAccountName'" -ErrorAction SilentlyContinue)) {
            try {
                New-ADUser -Name $user `
                    ...
                    -UserPrincipalName "$samAccountName@mirage.com" `
                    -Path $ouPath `
