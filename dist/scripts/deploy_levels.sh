...
if [[ "$response" == "[]" ]]; then
   ...
   send_request "Miroir du Domaine" 8 "Danny Ocean et le reste de l’équipe se trouvent désormais dans la chambre forte du MGM Grand. <br><br>Votre mission est de les faire ressortir de cet endroit avec un maximum d’argent. Pour cela, il vous faudra réaliser un dump de la mémoire des comptes du MGM Grand afin d’obtenir les informations nécessaires pour ouvrir le plus de coffres possibles.<br><br>." "DannyOcean" 800
   send_request "Miroir du Domaine" 9 "Danny Ocean et le reste de l’équipe se trouvent désormais dans la chambre forte du MGM Grand. <br><br>Votre mission est de les faire ressortir de cet endroit avec un maximum d’argent. Pour cela, il vous faudra réaliser un dump de la mémoire des comptes du MGM Grand afin d’obtenir les informations nécessaires pour ouvrir le plus de coffres possibles.<br><br>." "DannyOcean" 900
   send_request "Miroir du Domaine" 10 "Danny Ocean et le reste de l’équipe se trouvent désormais dans la chambre forte du MGM Grand. <br><br>Votre mission est de les faire ressortir de cet endroit avec un maximum d’argent. Pour cela, il vous faudra réaliser un dump de la mémoire des comptes du MGM Grand afin d’obtenir les informations nécessaires pour ouvrir le plus de coffres possibles.<br><br>." "DannyOcean" 1000
   send_request "Miroir du Domaine" 11 "Danny Ocean et le reste de l’équipe se trouvent désormais dans la chambre forte du MGM Grand. <br><br>Votre mission est de les faire ressortir de cet endroit avec un maximum d’argent. Pour cela, il vous faudra réaliser un dump de la mémoire des comptes du MGM Grand afin d’obtenir les informations nécessaires pour ouvrir le plus de coffres possibles.<br><br>." "DannyOcean" 1100
   send_request "Miroir du Domaine" 12 "Danny Ocean et le reste de l’équipe se trouvent désormais dans la chambre forte du MGM Grand. <br><br>Votre mission est de les faire ressortir de cet endroit avec un maximum d’argent. Pour cela, il vous faudra réaliser un dump de la mémoire des comptes du MGM Grand afin d’obtenir les informations nécessaires pour ouvrir le plus de coffres possibles.<br><br>." "DannyOcean" 1200
